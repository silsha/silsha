...
- [silsha/tablepress_chartist](https://github.com/silsha/tablepress_chartist) - 📊 Create a responsive chart based on the data in a TablePress table (4 weeks ago)
...
- [everythingishacked/Pants](https://github.com/everythingishacked/Pants) - A video filter to add pants or blur out your lower half on Zoom calls when you forget to wear pants (3 days ago)
- [LilithWittmann/transparency](https://github.com/LilithWittmann/transparency) - Transparenzreport (3 days ago)
