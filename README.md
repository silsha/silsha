...
- [Baekdal/Bird-ID-detector-like-MerlinID](https://github.com/Baekdal/Bird-ID-detector-like-MerlinID) - The Merlin Bird ID is great, but it has one major flaw. When it&#39;s recording audio to detect the birds, stores that file. This create a privacy problem because it means it&#39;s also recording everything else, including you. This Python script solves that by streaming the audio instead. The audio is this never saved, but you still get to known the birds (3 days ago)
